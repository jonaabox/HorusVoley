        ...
        <div className="px-6 pb-4">
          <div className="flex flex-col gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex max-w-fit items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg text-xs font-bold transition-all shadow-sm"
              onClick={(e) => {
                if (!alumno.telefono) {
                  e.preventDefault()
